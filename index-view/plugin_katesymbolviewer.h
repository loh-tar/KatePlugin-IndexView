...
class KatePluginSymbolViewerView :  public QObject, public KXMLGUIClient
{
  ...
  public Q_SLOTS:
    ...
    void slotDocEdited();
    // Do you prefer other names for these? e.g. loadDisplayOptions ?
    void loadConfig();
    void saveConfig();
  ...
  private:
    ...
    // I chose a more generic name because the "highlightMode" we ask
    // is only a randomly suitable emergency aid,
    // "m_docType" would be my preffered name, shorter but still full understandable.
