...
public:
    PlainTextParser(QObject *view, KTextEditor::Document *doc);
   ~PlainTextParser();
...
public:
    IniFileParser(QObject *view, KTextEditor::Document *doc);
    ~IniFileParser();
...
public:
    DiffFileParser(QObject *view, KTextEditor::Document *doc);
    ~DiffFileParser();
